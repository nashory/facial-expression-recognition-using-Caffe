...
if __name__=="__main__":
	...
	train_input = img_path + '/train'
	test_input = img_path + '/test'
	val_input = img_path + '/val'
	...
	Save_resize_and_Hist(db_name, test_input, test_output, size)
	Save_resize_and_Hist(db_name, val_input, val_output, size)
